...
class Lesson(Base):
    ...
    # Timed free preview (Option 3): visitors get only a real clip of
    # this many seconds (preview_video_url, generated by the browser
    # encoder). NULL seconds/clip = legacy behavior (full video when
    # is_free_preview).
    free_preview_seconds = Column(Integer)
